...
class LockManager {
 ...
 public:
  ...
  bool NeedWaitShared(Transaction *txn, const RID &rid);

  bool NeedWaitExclusive(Transaction *txn, const RID &rid);

  bool NeedWaitUpgrade(Transaction *txn, const RID &rid);
